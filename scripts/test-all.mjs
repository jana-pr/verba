...
import { calculateMasteryUpdate, calculateOverallState } from '../src/lib/spaced-repetition.js';
import { evaluateAnswer, normalizeAnswer } from '../src/lib/evaluation.js';
import { generateCurriculumOutline, generateLessonContent } from '../src/lib/ai/course-generator.js';
...
assert.strictEqual(normalizeAnswer("Don't allocate!"), "don't allocate");
