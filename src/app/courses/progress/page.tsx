...
import { getFullCourseProgress } from '@/lib/data-repository';
    ...
    return (
      <AppLayout activeCourseId={id}>
        <div className="text-center py-20 text-verba-slate">
          <p className="font-semibold text-base mb-2">Data kurzu nebyla nalezena.</p>
  ...
  return (
    <AppLayout activeCourseId={id}>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="verba-card p-5 space-y-2">
            ...
            <div className="text-[11px] text-verba-slate">
              {stats?.mastered || 0} z {stats?.totalItems || 0} položek plně zvládnuto
            </div>
          </div>
        ...
        {/* Bidirectional Mastery Comparison */}
              ...
              <div className="space-y-2.5">
                {weakLessons.map((wl: any) => (
                  ...
                  >
                    ...
                    <Link
                      href={`/courses/practice?id=${id}&lessonId=${wl.lesson_number}`}
...
export default function ProgressPage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center py-20 text-verba-slate">Načítání přehledu postupu...</div>}>
      <ProgressContent />
    </Suspense>
  );
}
