...
import { getCourseDetail } from '@/lib/data-repository';
    ...
    getCourseDetail(id)
      .then((data) => {
        if (data.course) {
          ...
          setCurrentStep(data.course.completed_lessons_count || 50);

          if (data.course.status === 'ready' || (data.course.completed_lessons_count || 0) >= 50) {
            setIsCompleted(true);
            setIsGenerating(false);
          } else {
            setIsCompleted(true);
      ...
      <div className="max-w-2xl mx-auto py-8 space-y-8">
        ...
        <div className="verba-card p-6 sm:p-8 space-y-6">
          ...
          <div className="pt-2 flex items-center justify-between">
            ...
            {isCompleted && (
              <button
                onClick={() => router.push(`/courses/view?id=${id}`)}
...
export default function GenerateCoursePage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center py-20 text-verba-slate">Načítání...</div>}>
